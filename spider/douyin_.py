...
class DouYin(object):
	...
	def get_video_urls(self, user_id):
		...
		user_url = 'https://www.douyin.com/aweme/v1/aweme/post/?user_id=%s&max_cursor=0&count=%s' % ('37343461246', aweme_count)
		req = requests.get(url = user_url, headers=self.headers)
		html = json.loads(req.text)
		i = 1
